#!/usr/bin/env python3
"""Standalone entry for the fact-integrity skill.
...
if __name__ == "__main__":
    raise SystemExit(run_standalone("fact-integrity", detectors,
                                    "Will it take away the correct fact, and can that fact be dated and attributed?"))
