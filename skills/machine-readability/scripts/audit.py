#!/usr/bin/env python3
"""Standalone entry for the machine-readability skill.

    python skills/machine-readability/scripts/audit.py https://example.com
...
if __name__ == "__main__":
    raise SystemExit(run_standalone("machine-readability", detectors,
                                    "Can a retrieval agent reach these pages and extract text from them?"))
